                    ...
                    <div class="contact-form">
                        <form>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input type="email" class="form-control" placeholder="{{ __('contact.email') }}" />
                                </div>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="{{ __('conact.subject') }}" />
                            </div>
                            <div class="form-group">
                                <textarea class="form-control" rows="5" placeholder="{{ __('contact.message') }}"></textarea>
                            </div>
                            <div><button class="btn" type="submit">{{ __('contact.send') }}</button></div>
                        </form>
                    </div>
                </div>
                <div class="col-lg-12">
